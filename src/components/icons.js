// ═══════════════════════════════════════════
// Caudal v2.0 — SVG Icon Components
// ═══════════════════════════════════════════
...
export function PencilIcon({ className = "w-4 h-4" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      ...
      <path d="M3.5 5.75c0-.414.336-.75.75-.75H7a.75.75 0 0 1 0 1.5H4.25v9.5h9.5V13a.75.75 0 0 1 1.5 0v3.25a.75.75 0 0 1-.75.75H4.25A1.75 1.75 0 0 1 2.5 15.25V6.5c0-.414.336-.75.75-.75Z" />
    </svg>
  )
}
...
export function FolderIcon({ className = "w-10 h-10" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h3.382c.48 0 .935-.19 1.274-.528l1.09-1.09a2.25 2.25 0 0 1 1.591-.66h4.913a2.25 2.25 0 0 1 2.25 2.25v2.25m-19.5 0A2.25 2.25 0 0 0 4.5 15h15a2.25 2.25 0 0 0 2.25-2.25m-19.5 0v4.5A2.25 2.25 0 0 0 4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25v-4.5" />
    </svg>
  )
}
...
export function TrendUpIcon({ className = "w-4 h-4" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M12.577 4.878a.75.75 0 0 1 .919-.53l4.78 1.281a.75.75 0 0 1 .531.919l-1.281 4.78a.75.75 0 0 1-1.449-.387l.81-3.022a19.407 19.407 0 0 0-5.594 5.203.75.75 0 0 1-1.139.093L7 10.06l-4.72 4.72a.75.75 0 0 1-1.06-1.06l5.25-5.25a.75.75 0 0 1 1.06 0l3.046 3.045a20.904 20.904 0 0 1 5.441-5.185l-2.829-.757a.75.75 0 0 1-.53-.919Z" clipRule="evenodd" />
    </svg>
  )
}

export function TrendDownIcon({ className = "w-4 h-4" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
...
export function EyeSlashIcon({ className = "w-4 h-4" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M3.28 2.22a.75.75 0 0 0-1.06 1.06l14.5 14.5a.75.75 0 1 0 1.06-1.06l-1.745-1.745a10.029 10.029 0 0 0 3.3-4.385 1.65 1.65 0 0 0 0-1.185A10.004 10.004 0 0 0 9.999 3a9.956 9.956 0 0 0-4.744 1.194L3.28 2.22ZM7.752 6.69l1.092 1.092a2.5 2.5 0 0 1 3.374 3.375l1.091 1.091a4 4 0 0 0-5.557-5.557ZM10 15a9.97 9.97 0 0 1-4.757-1.206l1.328-1.328A4 4 0 0 0 12.534 8.53l1.328-1.328A9.97 9.97 0 0 1 10 15Zm-7.736-4.41a9.96 9.96 0 0 1 2.23-3.411l1.17 1.17A8.472 8.472 0 0 0 3.378 10a8.472 8.472 0 0 0 2.286 1.651l-1.17 1.17A9.96 9.96 0 0 1 2.264 10.59Z" clipRule="evenodd" />
    </svg>
  )
}
