    ...
    <main className="p-6 max-w-6xl mx-auto w-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2 bg-gray-100 p-1.5 rounded-lg border">
          <button
            ...
            className="px-3 py-1 bg-white hover:bg-gray-200 rounded border text-sm font-semibold"
          >
            ←
          </button>
      ...
      <div className="mb-8 bg-gray-50 p-6 rounded-lg border">
        ...
        <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
          ...
          />
          <button onClick={handleSubmit} className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded font-medium">
            Save
          </button>
        </div>
      </div>
